        ...
        <article className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-3 items-start">
              {executiveAlerts.length > 0 ? executiveAlerts.map((alert: any, i: number) => (
                <div key={i} className="p-3.5 bg-slate-50 rounded-xl border border-slate-100 hover:border-[#0b5156]/20 transition-all group">
        ...
        <div className="py-2.5 px-3.5 border-b border-slate-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-3 bg-slate-50/30">
          ...
          <div className="flex gap-2 w-full md:w-auto">
             <div className="relative flex-1 md:flex-none">
                ...
                <input type="text" placeholder="Buscar reporte..." className="w-full md:w-64 bg-white border border-slate-200 rounded-lg pl-8 pr-3 py-1.5 text-xs font-bold text-[#0b5156] outline-none focus:border-[#0b5156] shadow-sm" />
             </div>
        ...
        <div className="overflow-x-auto no-scrollbar">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-slate-50 text-xs">
              {availableReports.map((report: any, i: number) => (
                <tr 
                  key={i} 
