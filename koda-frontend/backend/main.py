        ...
        try:
            with engine.begin() as connection:
                ...
                if engine.name != "sqlite":
                    ...
                    connection.execute(text("ALTER TABLE public.ventas ADD COLUMN IF NOT EXISTS pago_movil_banco VARCHAR(100);"))
                    connection.execute(text("ALTER TABLE public.ventas ADD COLUMN IF NOT EXISTS pago_movil_cedula VARCHAR(20);"))
                    connection.execute(text("ALTER TABLE public.ventas ADD COLUMN IF NOT EXISTS pago_movil_telefono VARCHAR(20);"))
                    connection.execute(text("ALTER TABLE public.ventas ADD COLUMN IF NOT EXISTS pago_movil_referencia VARCHAR(50);"))
